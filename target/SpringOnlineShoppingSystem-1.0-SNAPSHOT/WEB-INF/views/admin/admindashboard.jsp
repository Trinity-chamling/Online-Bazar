<%-- 
    ...
    Created on : Jan 23, 2019, 2:41:43 PM
    Author     : test
--%>
...
<head>
    ...
    <title>Online-Bazar Admin Dashboard</title>
</head>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Online-Bazar Dashboard </h2>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Online-Bazar Dashboard</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td>
                                                            <div class="m-r-10"><img src="${pageContext.request.contextPath}/resources/assets/images/product-pic.jpg" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>Product #1 </td>
                                                        <td>id000001 </td>
                                                        <td>20</td>
                                                    ...
                                                    <tr>
                                                        <td colspan="9"><a href="${pageContext.request.contextPath}/admin/order/view" class="btn btn-outline-light float-right">View More</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
